...
sum(totaltaka) as totaltaka FROM sales WHERE farm_name = '{$_SESSION["username"]}' AND {$dateCond} AND {$product} OR usertype = '{$_SESSION["usertype"]}' AND {$dateCond} AND {$product} GROUP BY farm_name, salesdate, rate, product order by product, salesdate asc";
...
<html>
  ...
  <body>
    <div align="center" class="container mt-5">
      <h5 align="left">Product Sales Summary Report by Sales Date & Product Filter</h5><br>
      <form class="myForm" method="get" enctype="application/x-www-form-urlencoded" action="index.php">
        ...
        <div class="form-row" align="left">
          <div class="form-group col-md-3 offset-md-3">
            <a href="index.php" class="btn btn-warning btn-block"><i class="fa fa-refresh"></i> Reset</a></span>
          </div>
          <div class="form-group col-md-3">
